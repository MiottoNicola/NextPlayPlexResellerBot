...
<html>
    <body>
        ...
        <div class="w3-card-4 w3-light-grey w3-padding-large w3-margin-top w3-round-large" style="max-width: 600px; margin: auto;">
            <h1 class="w3-center">Modifica Coupon</h1>
            <?php
            ...
            <form action="modifica.php" method="POST">
                ...
                <div class="w3-row w3-margin-bottom">
                    ...
                    <div class="w3-col s8">
                        <input type="text" class="w3-input" id="code" name="code" value="<?php echo $code; ?>" required>
                    </div>
                </div>
                <div class="w3-row w3-margin-bottom">
                    <div class="w3-col s4">
                ...
                <div class="w3-row w3-margin-bottom">
                    ...
                    <div class="w3-col s8">
                        <input type="number" class="w3-input" id="value" name="value" value="<?php echo $value; ?>" min="0" required>
                    </div>
                </div>
